 ...
 * @param value 待检测的值
 */
exports.email = function (value) { return patterns.EMAIL.test(value); };
/**
 * 检测一个值是否为URL地址
 *
 * @param value 待检测的值
 */
exports.url = function (value) { return patterns.URL.test(value); };
/**
 * 检测一个值是否为 URL 安全的
 *
 * @param value 待检测的值
 */
exports.urlSafe = function (value) { return patterns.URL_SAFE.test(value); };
/**
 * 检测一个字符串是否为手机号
 *
