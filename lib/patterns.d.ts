 ...
 * 只包含 a-z 小写字母
 */
export declare const LOWER_CASE: RegExp;
/**
 * 只包含 A-Z 大写字母
 */
export declare const UPPER_CASE: RegExp;
/**
 * 只包含数字和字母的字符验证正则
 */
export declare const NUMBER_ALPHA: RegExp;
/**
 * 只有大小写字母+数字以及中文字符
 */
export declare const CHARACTER: RegExp;
/**
 * 货币数字验证
 */
export declare const CURRENCY: RegExp;
export declare const TIME: RegExp;
export declare const FULLTIME: RegExp;
export declare const TIME_OR_FULLTIME: RegExp;
export declare const DATE: RegExp;
export declare const HEX: RegExp;
export declare const HEXA: RegExp;
export declare const HEX_OR_HEXA: RegExp;
export declare const RGB: RegExp;
export declare const RGBA: RegExp;
